...
public class HealthQuestionnaire implements Serializable {
     ...
     * @return True if other object is instance of class HealthQuestionnaire and the key objects are equal
     */
    ...
    public boolean equals(Object other) {
        if (!(other instanceof HealthQuestionnaire)) return false;
