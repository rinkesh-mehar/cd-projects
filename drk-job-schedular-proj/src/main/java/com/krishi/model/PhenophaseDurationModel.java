...
public class PhenophaseDurationModel {
...
//		entity.setSeasonId(SeasonID);
		...
		entity.setHarvestWeekStart(HarvestWeekStart);
		entity.setHarvestWeekEnd(HarvestWeekEnd);
		return entity;
	}
