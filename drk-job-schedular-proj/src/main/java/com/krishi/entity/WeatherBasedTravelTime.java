 ...
 */
@Entity
@Table(name = "weather_based_travel_time")
public class WeatherBasedTravelTime implements Serializable {
	...
	public String getMinPerKm() {
		return minPerKm;
	}

	public void setMinPerKm(String minPerKm) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WeatherBasedTravelTime other = (WeatherBasedTravelTime) obj;
		if (id == null) {
			if (other.id != null)
				return false;
