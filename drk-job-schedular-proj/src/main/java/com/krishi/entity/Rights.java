...
public class Rights implements Cloneable, EntityModel {
	...
	public Rights(String id, Integer versionNumber, String caseId, Float currentQuantity, Float estimatedQuantity,
				  ...
				  String internationalRestriction, Date deliveryDate, String logisticHubId, String logisticHubAddress,
				  String farmerDefault, String splitField, String geographicallyAdjustent, String riskReport,
				  String rightCertificate, Integer recordCreatedBy, Timestamp recordDateTime, String status,
				  Date statusReceivingDate, String comments, String lotId, Boolean isVerified, String transactionId,
				  Integer phenophaseId, String rightSignUrl, String blockchainStatus, Integer varietyId) {
		super();
		this.id = id;
	...
	public void setRecordDateTime(String recordDateTime) {
		try {
			...
			this.recordDateTime = new Timestamp(format.parse(recordDateTime).getTime());
		} catch (Exception e){}
	}
	...
	public void setBlockchainStatus(String sentToAgm) {
		this.blockchainStatus = sentToAgm;
	}
