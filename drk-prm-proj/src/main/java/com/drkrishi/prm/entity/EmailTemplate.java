...
public class EmailTemplate implements Serializable {
    ...
    /**
     * Compares the key for this instance with another EmailTemplate.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class EmailTemplate and the key objects are equal
     */
    ...
    /**
     * Compares this instance with another EmailTemplate.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof EmailTemplate)) return false;
        return this.equalKeys(other) && ((EmailTemplate)other).equalKeys(this);
    }
	...
	public String toString() {
		return "EmailTemplate [id=" + id + ", name=" + name + ", subject=" + subject + ", body=" + body + ", isActive="
