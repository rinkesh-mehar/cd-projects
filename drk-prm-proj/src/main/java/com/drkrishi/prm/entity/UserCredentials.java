...
public class UserCredentials implements Serializable {
     ...
     * @return True if other object is instance of class UserCredentials and the key objects are equal
     */
	...
	public String toString() {
		return "UserCredentials [id=" + id + ", createdBy=" + createdBy + ", createdDateTime=" + createdDateTime
				+ ", isOtp=" + isOtp + ", modifiedDateTime=" + modifiedDateTime + ", modifiedBy=" + modifiedBy
				+ ", passwordResetDate=" + passwordResetDate + ", systemPasswordExpired=" + systemPasswordExpired
				+ ", userPassword=" + userPassword + ", userId=" + userId + ", invalidAttempts=" + invalidAttempts + "]";
	}
