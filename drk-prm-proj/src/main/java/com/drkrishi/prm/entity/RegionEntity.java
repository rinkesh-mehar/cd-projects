...
public class RegionEntity implements Serializable {
    ...
    private boolean equalKeys(Object other) {
        ...
        if (!(other instanceof RegionEntity)) {
            return false;
        }
        RegionEntity that = (RegionEntity) other;
    ...
    public boolean equals(Object other) {
        if (!(other instanceof RegionEntity)) return false;
        return this.equalKeys(other) && ((RegionEntity)other).equalKeys(this);
    }
	...
	public String toString() {
		return "RegionEntity [regionId=" + regionId + ", tileId=" + tileId + ", stateId=" + stateId + ", latitude="
				+ latitude + ", longitude=" + longitude + ", regionName=" + regionName + ", description=" + description
