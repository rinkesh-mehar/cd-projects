...
@Entity
@Table(name="fertilizer_application_method")
public class FertilizerApplicationMethod implements Serializable {
    ...
    private boolean equalKeys(Object other) {
        ...
        if (!(other instanceof FertilizerApplicationMethod)) {
            return false;
        }
        FertilizerApplicationMethod that = (FertilizerApplicationMethod) other;
    ...
    public boolean equals(Object other) {
        if (!(other instanceof FertilizerApplicationMethod)) return false;
        return this.equalKeys(other) && ((FertilizerApplicationMethod)other).equalKeys(this);
    }
