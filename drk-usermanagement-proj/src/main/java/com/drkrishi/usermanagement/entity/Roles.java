...
public class Roles implements Serializable {
	...
	public String toString() {
		return "Roles [id=" + id + ", ecosystemId=" + ecosystemId + ", code=" + code + ", name=" + name + ", isManager="
				+ isManager + ", reportingTo=" + reportingTo + ", getId()=" + getId() + ", getEcosystemId()="
				+ getEcosystemId() + ", getCode()=" + getCode() + ", getName()=" + getName() + ", getIsManager()="
				+ getIsManager() + ", getReportingTo()=" + getReportingTo() + ", hashCode()=" + hashCode()
				+ ", getPrimaryKey()=" + getPrimaryKey() + ", getClass()=" + getClass() + ", toString()="
				+ super.toString() + "]";
	}
