...
import { DRKrishiTechnicalForm, Cropinformation, Irrigationdetails, Fertilizer, Seedtreatment, Remedialmeasure, Ndviimage, Schedule, saveSchedule, callingStatusModel, ndviImages } from '../technical-form/technical-form.model';
import { DrKrishiTechnicalFormService } from '../technical-form/technical-form.service';
...
@Component({
  ...
  styleUrls: ['./incomplete.component.less']
})
        ...
        (data) => {
          ...
          if (data.status == 200) {
            ...
            const initialState = {
              title: "Error",
              content: data.message,
              action: "/dr-krishi-incomplete-data/" + this.taskId
            };
            this.modalRef = this.modalService.show(SuccessModalComponent, { initialState, backdrop: 'static', keyboard: false });
            return;
          }
