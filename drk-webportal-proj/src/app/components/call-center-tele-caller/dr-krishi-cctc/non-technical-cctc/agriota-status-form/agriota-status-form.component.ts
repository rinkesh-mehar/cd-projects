...
@Component({
  selector:'app-agriota-status-form',
  templateUrl:'./agriota-status-form.component.html',
  styleUrls: ['./agriota-status-form.component.less']
})
export class AgriotastatusformComponent implements OnInit{
