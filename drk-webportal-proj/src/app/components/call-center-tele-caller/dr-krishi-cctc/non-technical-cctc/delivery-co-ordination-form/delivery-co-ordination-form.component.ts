...
import { DeliveryCoordinationForm, FormResponse, MasterDataList, SubmitNontechincal } from './delivery-co-ordination-form.model';
import { DeliveryCoordinationFormService } from './delivery-co-ordination-form.service';
@Component({
      selector:'app-delivery-co-ordination-form',
      templateUrl:'./delivery-co-ordination-form.component.html',
      styleUrls: ['./delivery-co-ordination-form.component.less']
})
export class DeliverycoordinationformComponent implements OnInit{
      ...
      constructor(
            ...
            private deliveryCoordinationFormService: DeliveryCoordinationFormService,
          ) {
          ...
          submitted = false;
          public information: DeliveryCoordinationForm;
          ...
          public DrKrishiNonNonTechnicalInformationFormService() {
            ...
            this.deliveryCoordinationFormService.getDrKrishiNonTechnicalSpotFormService(this.taskId).subscribe(
              ...
              (data: FormResponse) => {
                if (data.status == 200) {
                  ...
                  const initialState = {
                    ...
                    action: '/dr-krishi-non-technical-information-delivery-co-ordinat-form'
                  };
                ...
                const initialState = {
                  ...
                  action: '/dr-krishi-non-technical-information-delivery-co-ordinat-form/' + this.taskId
                };
                this.modalRef = this.modalService.show(SuccessModalComponent, { initialState, backdrop: 'static', keyboard: false });
                return;
              });
            ...
            if (!this.informationForm.invalid) {
              ...
              if (this.information.primarymobilemo === this.information.alternatemobileno) {
                ...
                if (this.information.masterData.farmerCropInfoList.length == 0) {
                  ...
                  this.deliveryCoordinationFormService.submitDrKrishiNonTechnicalInformationForm(this.submitinformation).subscribe(
                    (data) => {
          ...
          onSaveFarmerCropInfo() {
           ...
           if (this.checkExistFarmerCrop()){
            ...
            this.deliveryCoordinationFormService.saveAndUpdateFarmerCropInfo(this.farmerCrop.value).subscribe(
              (data) => {
          ...
          public onEditFarmerCropInfo(farmercrops: TemplateRef<any>, farmerCropId: string) {
            this.addEditFlsg = true;
            this.deliveryCoordinationFormService.getFarmerCropInfo(farmerCropId).subscribe(
              (data) => {
                ...
                if (data.status == 200) {
                  ...
                  this.deliveryCoordinationFormService.getVarietyList(this.commodityId).subscribe(
                    (data) => {
                      if (data.status = 200) {
                        this.varietyList = data.data;
                      }
                      this.deliveryCoordinationFormService.geFarmerCropListByTaskId(this.taskId).subscribe(
                        (data) => {
                          if (data.status = 200) {
                            this.existingFarmerCropInfo = data.data;
          ...
          public onDeleteFarmerCropInfo(cropInfoId: string) {
            this.addEditFlsg = true;
            this.deliveryCoordinationFormService.deleteFarmerCropInfo(cropInfoId).subscribe(
              (data) => {
