...
import { DeliveryConfirmationForm, FormResponse, MasterDataList, SubmitNontechincal } from './delivery-confirmation-form.model';
import { DeliveryConfirmationFormService } from './delivery-confirmation-form.service';
@Component({
      selector:'app-delivery-confirmation-form',
      templateUrl:'./delivery-confirmation-form.component.html',
      styleUrls: ['./delivery-confirmation-form.component.less']
})
export class DeliveryconfirmationformComponent implements OnInit{
      ...
      constructor(
            ...
            private deliveryConfirmationFormService: DeliveryConfirmationFormService,
          ) {
          ...
          submitted = false;
          public information: DeliveryConfirmationForm;
          ...
          public DrKrishiNonNonTechnicalInformationFormService() {
            ...
            this.deliveryConfirmationFormService.getDrKrishiNonTechnicalSpotFormService(this.taskId).subscribe(
              ...
              (data: FormResponse) => {
                if (data.status == 200) {
                  ...
                  const initialState = {
                    ...
                    action: '/dr-krishi-non-technical-information-deliver-confirm-form'
                  };
                ...
                const initialState = {
                  ...
                  action: '/dr-krishi-non-technical-information-deliver-confirm-form/' + this.taskId
                };
                this.modalRef = this.modalService.show(SuccessModalComponent, { initialState, backdrop: 'static', keyboard: false });
                return;
              });
            ...
            if (!this.informationForm.invalid) {
              ...
              if (this.information.primarymobilemo === this.information.alternatemobileno) {
                ...
                if (this.information.masterData.farmerCropInfoList.length == 0) {
                  ...
                  this.deliveryConfirmationFormService.submitDrKrishiNonTechnicalInformationForm(this.submitinformation).subscribe(
                    (data) => {
                      ...
                      if (data.status == 200) {
                        const initialState = {
                          ...
                          action: '/dr-krishi-non-technical-deliver-confirm-list'
                        };
                        this.modalRef = this.modalService.show(SuccessModalComponent, {initialState, backdrop: 'static', keyboard: false});
                        return;
                      } else {
          ...
          onSaveFarmerCropInfo() {
           ...
           if (this.checkExistFarmerCrop()){
            ...
            this.deliveryConfirmationFormService.saveAndUpdateFarmerCropInfo(this.farmerCrop.value).subscribe(
              (data) => {
          ...
          public onEditFarmerCropInfo(farmercrops: TemplateRef<any>, farmerCropId: string) {
            this.addEditFlsg = true;
            this.deliveryConfirmationFormService.getFarmerCropInfo(farmerCropId).subscribe(
              (data) => {
                ...
                if (data.status == 200) {
                  ...
                  this.deliveryConfirmationFormService.getVarietyList(this.commodityId).subscribe(
                    (data) => {
                      if (data.status = 200) {
                        this.varietyList = data.data;
                      }
                      this.deliveryConfirmationFormService.geFarmerCropListByTaskId(this.taskId).subscribe(
                        (data) => {
                          if (data.status = 200) {
                            this.existingFarmerCropInfo = data.data;
          ...
          public onDeleteFarmerCropInfo(cropInfoId: string) {
            this.addEditFlsg = true;
            this.deliveryConfirmationFormService.deleteFarmerCropInfo(cropInfoId).subscribe(
              (data) => {
