...
import in.cropdata.aefc.filter.JwtAuthenticationEntryPoint;
import in.cropdata.aefc.filter.JwtRequestFilter;
...
//				.antMatchers("/authenticate").permitAll()
				...
				.antMatchers("/aefc/getOTP").permitAll()
				.antMatchers("/authenticate").permitAll()
				.antMatchers("/validateOTP").permitAll()
				.antMatchers("/getOTP").permitAll()
				.antMatchers("/verifiedUserDetails/**").permitAll()
